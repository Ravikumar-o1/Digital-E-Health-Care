...
adam = optimizers.Adam()model = Model(inputs=[inputShape, labels, input_length, label_length], outputs=[loss_out])  # the model for trainning
...
model.fit_generator(img_gen(input_shape=bn_shape), steps_per_epoch=1000, epochs=20, verbose=1,
                    callbacks=[evaluator,
                               checkpoint,
